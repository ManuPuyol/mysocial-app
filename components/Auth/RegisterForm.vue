<template>
  ...
  >
    <div class="flex justify-center">
      <h2 class="text-lg font-bold text-orange-400">Register</h2>
    </div>
    <div class="pt-5 space-y-6">
      ...
      <button
        ...
        type="button"
        class="fx-5 py-2.5 text-center inline-flex items-center text-orange-400 dark:text-white"
      >
        <svg
          class="w-4 h-4 dark:text-white me-2"
          aria-hidden="true"
